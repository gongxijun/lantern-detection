...
if __name__ == "__main__":
    ...
    for image_path in os.listdir(root_path):
        ...
        scale_size = (min(img.shape[0], img.shape[1])/400.)  # 最大允许1000*1000的图像
            ...
            for y in xrange(0, im_scaled.shape[0], step_size[1]):
                ...
                for x in xrange(0, im_scaled.shape[1], step_size[0]):
                    if x + min_wdw_sz[0] > im_scaled.shape[1]:
                        break;
                    ##开启多线程.
                    job_manager.addJobTask(get_similarIamgeRect,
        ...
        file_path = '/home/gongxijun/data/demo/' + str(_num + 1) + '.jpg'
        clone = clone * 255
        cv2.waitKey(80)
